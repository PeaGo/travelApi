<?php
/**
 * @package     extends from Joomla.Platform
 *
 * @copyright   Freelancerviet.net
 * @license     GNU General Public License version 2 or later; see LICENSE
 */
require_once 'query_element.php';
class FvnModelQuery
{
	/**
	 * @var    wpdb  The database driver.
	 * @since  11.1
	 */
	protected $db = null;
	 ...
	 * Class constructor.
	 *
	 * @param   wpdb  $db  The database driver.
	 *
	 * @since   11.1
	 */
	...
	public function __toString()
	{
		...
		$query = str_replace('#__', $this->db->prefix, $query);
		return $query;
	}
	...
	{
		return '<pre class="jdatabasequery">' . str_replace('#__', $this->db->prefix, $this) . '</pre>';
	}
	 ...
	 *
	 * Note that 'e' is an alias for this method as it is in wpdb.
	 *
	 ...
	 *
	 * Note that 'q' is an alias for this method as it is in wpdb.
	 *
	 * Usage:
	 ...
	 *
	 * Note that 'qn' is an alias for this method as it is in wpdb.
	 *
	 * Usage:
	 * $query->quoteName('#__a');
	 * $query->qn('#__a');
